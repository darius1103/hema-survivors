...
export class Torso extends BodyPart {
    ...
    public defineSprite(): void {
        ...
        const data = [
            ...
            [0,0,2,3,3,3,3,3,3,3,3,3,2,0,0,0,0,0,0],
            [0,0,2,3,3,3,3,3,3,3,3,3,3,3,2,2,2,2,0],
            [0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,2],
            [0,0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,3,3,2],
            [0,0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,3,2,0],
            [0,0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,2,0,0],
            [0,0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,2,0,0],
            [0,0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,2,0,0],
            [0,0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,2,0,0],
            [0,0,0,2,3,3,3,3,3,3,3,3,3,3,3,3,2,0,0],
            [0,0,0,0,2,3,3,3,3,3,3,3,3,3,3,2,0,0,0],
            [0,0,0,0,2,3,3,3,3,3,3,3,3,3,3,2,0,0,0],
